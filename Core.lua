...
ns.strings = {
    ...
    -- section headers in the sound picker
    sndGrpAlerts = "Alerts",
    sndGrpToasts = "Chimes & Toasts",
    sndGrpQueues = "Queues & PvP",
    sndGrpMisc   = "Quiet & Quirky",
    sndGrpShared = "Shared Media",

    -- names of the selectable alert sounds
    sndTell        = "Whisper",
    sndBnetToast   = "Battle.net Toast",
    sndGMChat      = "GM Chat",
    sndBossWhisper = "Boss Whisper",
    ...
    sndAlarm2      = "Alarm 2",
    sndAlarm       = "Alarm 3",
    sndTutorial    = "Tutorial Popup",
    sndBell        = "Bell",
    sndPing        = "Map Ping",
    sndInvite      = "Group Invite",
    sndQuestDone   = "Quest Complete",
    sndQuestTurnIn = "Quest Turn-in",
    sndEpicLoot    = "Epic Loot",
    sndLegendary   = "Legendary Loot",
    sndLootBanner  = "Loot Banner",
    sndDigsite     = "Digsite Find",
    sndMission     = "Mission Complete",
    sndFollower    = "Follower Gained",
    sndInvasion    = "Invasion Alert",
    sndTalent      = "Talent Ready",
    sndWorldQuest  = "World Quest",
    sndRecord      = "New Record",
    sndSocialQueue = "Social Queue",
    sndApplication = "Group Application",
    sndScenario    = "Scenario Stage",
    sndTrap        = "Trap Ready",
    sndAura        = "Power Aura",
    sndLFGReward   = "Dungeon Reward",
    sndRoleCheck   = "Role Check",
    sndDenied      = "Queue Denied",
    sndQueueEnter  = "Enter Queue",
    sndQueuePop    = "Queue Pop",
    sndClick       = "Click",
    sndMenuClick   = "Menu Click",
    sndChatScroll  = "Chat Scroll",
    sndCoins       = "Coins",
    sndBobber      = "Fishing Bobber",
    sndAnvil       = "Anvil",
    sndJewel       = "Jewel Craft",
    sndCheers      = "Cheers",
    sndMurloc      = "Murloc",
